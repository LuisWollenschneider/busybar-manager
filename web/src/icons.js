...
export const icons = {
  ...
  // no firmware equivalent — Controller tab (remote keypad, POST /api/input).
  gamepad: s('<rect x="2.6" y="6.6" width="18.8" height="10.8" rx="4.2"/><path d="M7.4 10.4v3.2M5.8 12h3.2"/><circle cx="15.8" cy="11.2" r="1.05" fill="currentColor" stroke="none"/><circle cx="18.2" cy="13.6" r="1.05" fill="currentColor" stroke="none"/>'),
  // no firmware equivalent — the `off` state key.
  power: s('<path d="M12 3.4v8.2"/><path d="M17.6 6.5a7.6 7.6 0 1 1-11.2 0"/>'),
  // no firmware equivalent — the `busy` state key (do-not-disturb sign).
  busy: s('<circle cx="12" cy="12" r="8.4"/><line x1="7.4" y1="12" x2="16.6" y2="12"/>'),
  // no firmware equivalents — d-pad keys (up / down / back). `ok` uses checkmark.
  chevronUp: s('<polyline points="6 14.5 12 8.5 18 14.5"/>'),
  chevronDown: s('<polyline points="6 9.5 12 15.5 18 9.5"/>'),
  arrowLeft: s('<path d="M19.5 12H5.5"/><polyline points="11.5 6 5.5 12 11.5 18"/>'),
  // no firmware equivalent — the Schedule tab (outline = inactive, fill =
  // active), matching the settings/settingsOutline pairing above.
  clock: s('<circle cx="12" cy="12" r="8.75"/><polyline points="12 6.9 12 12.25 15.9 14.1"/>'),
  clockFill: f('<path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2ZM11 6V12.6459L15.4453 14.8945L16.3535 13.1055L13 11.4082V6H11Z" fill="currentColor"/>'),
